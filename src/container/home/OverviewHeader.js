  ...
  return (
    <div className="relative h-[120vh] md:h-100vh lg:max-h-[1038px] py-[100px]">
      <div className="container mx-auto h-full">
          ...
          <div data-aos="fade-right">
            ...
            <div className="text-white flex justify-center">
              <p className="text-lg w-4/6 text-center">
                ...
                texnologiyalari bilan birgalikda xalqaro darajaga olib chiqamiz!
              </p>
            </div>
          </div>
          <div>
        ...
        <div data-aos="fade-up" className="relative w-full flex items-center justify-center top-20 max-md:top-28">
